...
Once you've dumped your cartridge to a `.ws` file, patching it with the English Translation can be done easily through the :guide-link{url="/patch/ws" text="ROM Patcher"} tool we provide, or by manually downloading the patch `.xdelta` file and using patching software, such as [DeltaPatcher](https://github.com/marco-calautti/DeltaPatcher/releases/) to patch your ROM file.
