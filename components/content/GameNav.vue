...
<template>
    <div class="game-nav">
        ...
        <div class="nav-buttons">
            ...
            <ButtonLink v-if="PATCH_DATA.platforms[defaultPlatform].cheats != undefined" :link="PATCH_DATA.platforms[defaultPlatform].cheat_link != undefined ? PATCH_DATA.platforms[defaultPlatform].cheat_link : 'https://drive.google.com/drive/folders/1dR-qZnwilFA4xebA06hh8U-hIJFdly1c?usp=sharing'" fullwidth rgbColor="#42ace6" icon="fa6-solid:bolt" :type="PATCH_DATA.walkthrough_link != undefined ? 'mid-piece' : 'top-piece'">
                {{ $t('cheats') }}
            </ButtonLink>
